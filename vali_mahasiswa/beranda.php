...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-info-circle"></i> Pengumuman</h1>
      <p class="app-welcome"></p>
    </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="tile">
        <h3 class="tile-title">Persyaratan Ujian</h3>
        <ul>
          <li>Bug.Js Integration compact inline</li>
