      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Forms</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="form-custom"><i class="icon fa fa-circle-o"></i> Custom Components</a></li>
        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="tile-title-w-btn">
              ...
              <p><a class="btn btn-primary icon-btn" href="https://select2.github.io/examples" target="_blank"><i class="fa fa-file"></i>Docs</a></p>
            </div>
            <div class="tile-body">
        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="tile-title-w-btn">
              ...
              <p><a class="btn btn-primary icon-btn" href="http://bootstrap-datepicker.readthedocs.org/en/stable/options" target="_blank"><i class="fa fa-file"></i>Docs</a></p>
            </div>
            <div class="tile-body">
